...
## ResetEvent の構造
- **定義 XSD**: [fpml-business-events-5-12.xsd](file:///e:/dev/python/my_fpml_wiki/confirmation/fpml-business-events-5-12.xsd#L939) (`complexType ResetEvent`)
- **要素名**: `<reset>` ([fpml-business-events-5-12.xsd:L1511](file:///e:/dev/python/my_fpml_wiki/confirmation/fpml-business-events-5-12.xsd#L1511))
- **所属グループ**: `PostTradeEventsBase.model` ([Line 1491](file:///e:/dev/python/my_fpml_wiki/confirmation/fpml-business-events-5-12.xsd#L1491))
- **主要構成要素**:
...
- **定義 XSD**: [fpml-confirmation-processes-5-12.xsd:L305](file:///e:/dev/python/my_fpml_wiki/confirmation/fpml-confirmation-processes-5-12.xsd#L305) / [Line 799](file:///e:/dev/python/my_fpml_wiki/confirmation/fpml-confirmation-processes-5-12.xsd#L799)
- **公式サンプル実績**:
  - [reset_ex01.xml](file:///e:/dev/python/my_fpml_wiki/confirmation/business-processes/reset/reset_ex01.xml#L10)
  - [reset_ex02_reset_with_observations.xml](file:///e:/dev/python/my_fpml_wiki/confirmation/business-processes/reset/reset_ex02_reset_with_observations.xml#L10)
- **評価**:
...
- **定義 XSD**: `fpml-confirmation-processes-5-12.xsd` / `fpml-msg-5-12.xsd`
- **評価**:
...
- **定義 XSD**: [fpml-confirmation-processes-5-12.xsd:L699](file:///e:/dev/python/my_fpml_wiki/confirmation/fpml-confirmation-processes-5-12.xsd#L699)
- **評価**:
  - **メリット**: Fixing 確定に伴って契約自体（`Trade`）を変更・再定義する場合に適用可能。
  - **デメリット**: `TradeChangeContent` ([fpml-business-events-5-12.xsd:L1019](file:///e:/dev/python/my_fpml_wiki/confirmation/fpml-business-events-5-12.xsd#L1019)) による取引差し替えを目的とするため、定常的な Fixing/Reset 通知としては過剰。

### 4. `<dataDocument>` (【不適合】XSD 違反)
- **定義 XSD**: [fpml-doc-5-12.xsd:L326](file:///e:/dev/python/my_fpml_wiki/confirmation/fpml-doc-5-12.xsd#L326)
- **評価**:
